...
const PreviewProject = ({ Name, Description, Image }) => (
  <div className="flex items-center justify-center gap-6 my-4 shadow-xl bg-white/5 rounded-md p-4 w-1/2 mx-auto border-t-4 border-b-4 border-white/30 shadow-[0_0_10px_#000]">
    <Media
